...
int main(int argc, char** argv) {
  ...
  //  std::cout << sizeof(boost::multiprecision::int128_t) << " " << alignof(boost::multiprecision::int128_t) <<
  //  std::endl; std::cout << sizeof(int256) << " " << alignof(int256) << std::endl; std::cout << sizeof(bigint) << " "
  //  << alignof(bigint) << std::endl;
  //  return 0;
