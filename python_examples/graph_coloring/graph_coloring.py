...
if len(sys.argv) == 5 or len(sys.argv) == 4:
    ...
    print(
        "Using default arguments: python3 python/examples/graph_coloring/graph_coloring.py python/examples/graph_coloring/graph_77v-7chrom_adj_matrix.txt 5 python/examples/graph_coloring/graph_77v-7chrom_symmetries.txt 0")
